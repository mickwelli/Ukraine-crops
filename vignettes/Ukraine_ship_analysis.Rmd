...
Port_activity_ggdf %>% filter(month==8, port=='Odesa')
(115-312)/312*100

Port_activity_ggdf %>% filter(month==8, port=='Mariupol')
(98.1-266)/266*100
```
Interesting that activity at both ports decreased by 63%, which roughly equates to them being closed in 5 of 8 months (5/8*100 = 62.5%). Final calculation for the increase in activity at the Danube Delta below.

```{r echo = TRUE, fig.align='center', fig.height=10, fig.width=8, warning=FALSE, messages=FALSE}
Port_activity_ggdf %>% filter(month==8, port=='Danube Delta')
(85.3-47.5)/85.3*100
